...
def script_test_one_temperature(temperature_str, temperature_float):
    """
    Example
    temperature_str : "4-5"
    temperature_float : 4.5
    """

    # Input file
    raw_file = PATH + "r01cbb7fdt.NEF"
    output_dir = "./outputs"
    output_file = "temp-th-" + temperature_str + ".jpg"
    ...
    #color_img = temperature_simple(color_img, temperature_float)
    color_img = temperature_tanner_helland(color_img, temperature_float)
...
def script_test_several_temperatures():

    for i in range(15000,30001,2000):
        print(i)
        script_test_one_temperature(str(i), i)

script_test_several_temperatures()