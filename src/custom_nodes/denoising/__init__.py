...
NODE_CLASS_MAPPINGS = {**_AVG_NODES, **_BILATERAL_NODES, **_GAUSSIAN_NODES, **_MEDIAN_NODES, **_NL_MEANS_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_AVG_NAMES, **_BILATERAL_NAMES, **_GAUSSIAN_NAMES, **_MEDIAN_NAMES, **_NL_MEANS_NAMES}
