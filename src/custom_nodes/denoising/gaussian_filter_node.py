...
class GaussianFilerNode:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                ...
                "sigmaX": ("FLOAT", {"min": 0., "tooltip": tooltip["sigmaX"]}),
                "sigmaY": ("FLOAT", {"min": 0., "tooltip": tooltip["sigmaY"]}),
    ...
    def execute(self, 
        ...
        output_2d = gaussian_filter(input_2d, (kheight, kwidth), sigmaX, sigmaY, borderType, hint)
