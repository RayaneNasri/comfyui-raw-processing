...
NODE_CLASS_MAPPINGS = {**_CAMERA_NODES, **_GT_NODES, **_GW_NODES, **_COMP_NODES, **_WPR_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_CAMERA_NAMES, **_GT_NAMES, **_GW_NAMES, **_COMP_NAMES, **_WPR_NAMES}
